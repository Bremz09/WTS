...
RIDER_SPECS = {
    "Ellesse": [238.99, 222.18, 0.2154, 230.67, 242.76, 0.2298, 86.9, 15, 63, 1.01, 2.7, 2.0],
    "Liv":    [236.90, 206.23, 0.2017, 239.47, 225.79, 0.2419, 80.0, 15, 55, 0.98, 2.3, 2.2],
    "Petch":   [249.24, 183.07, 0.2050, 248.72, 198.04, 0.2563, 71.9, 15, 54, 0.96, 2.2, 2.1],
    "Shaane":  [233, 253, 0.2340, 227, 289, 0.2925, 91.8, 15, 85, 1.04, 2.9, 2.5],
    "Riley":  [214.15, 181.23, 0.2250, 209.81, 226.69, 0.2750, 80.0, 15, 56, 1.00, 2.4, 2.3]
}
